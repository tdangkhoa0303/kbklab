...
const ClassScoreDashboard: React.FC = () => {
	const {classCode, obtainGridValues} = useOutletContext<ScoreDashboardOutletContextValues>()
	const currentClass = useClassByCode(classCode);

	return !isNil(currentClass) ? <ClassScoreGrid currentClass={currentClass} onGridReady={obtainGridValues} /> : null
}

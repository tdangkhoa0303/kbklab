...
export type CreateLabInstanceResponseData = Pick<ClassLab, 'stepSuccess' | 'url'>;
export type CreateLabInstanceResponse = APIClientResponse<CreateLabInstanceResponseData>;
export type CreateLabInstanceFulfilledPayload = Pick<ClassLab, 'id' | 'stepSuccess' | 'url'>;
...
export type FinishLabAttemptResponse = APIClientResponse<FinishLabAttemptFulfilledPayload>;

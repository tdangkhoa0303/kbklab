...
export const lecturersSlice = createSlice<LecturersGridState, SliceCaseReducers<LecturersGridState>>({
...
export const lecturersUISlice = createSlice<LecturersUIState, SliceCaseReducers<LecturersUIState>>({
	name: AppContext.Lecturer,

...
export const importClasses = createAsyncThunk<ImportClassesResponse, ImportClassesPayload>(
	`${AppContext.Management}/importClasses`,
	async (data) => {
...
export const updateClassLab = createAsyncThunk<UpdateClassLabFulfilledPayload, UpdateClassLabPayload>(
	`${AppContext.Lab}/updateClassLab`,
	async (classLab) => {
		const {id} = classLab;
...
export const deleteClassLab = createAsyncThunk<DeleteClassLabFulfilledPayload, DeleteClassLabPayload>(
	`${AppContext.Lab}/deleteClassLab`,
	async (payload) => {

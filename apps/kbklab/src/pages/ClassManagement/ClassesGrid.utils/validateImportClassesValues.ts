...
const validateClassCode = (classCode: string | undefined): string => {
	...
	return classCode.match(/^[A-Z]{2}\d{4}$/g) ? '' : 'Follow the format IAxxxx. Ex: IA1403.'
}

export const validateImportClassesValues = (importValues: ImportClassesFormValues): FormikErrors<ImportClassesFormValues> => {

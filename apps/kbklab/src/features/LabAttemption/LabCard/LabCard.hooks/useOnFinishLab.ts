...
import {useFinishLab, useFinishLabStatus, useIsFinishingLab} from '../../hooks';
...
export const useOnFinishLab = ({isStudent, classLabId}: UseOnFinishLabParams): MouseEventHandler<HTMLButtonElement> => {

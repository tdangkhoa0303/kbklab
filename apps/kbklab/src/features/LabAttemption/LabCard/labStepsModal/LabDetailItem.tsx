...
import {LabFieldDefinition} from '../LabCard.types';
import {useLabField} from '../LabCard.context';
	...
	return (
		<Box mt={1} mb={3}>
			...
			{Component ? (
				...
				<Typography variant="body1">{formatter ? formatter(filedValue) : filedValue}</Typography>
			)}
		</Box>
	);
};

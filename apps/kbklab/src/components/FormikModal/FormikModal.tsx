...
export interface FormikModalProps<TValues extends FormikValues = FormikValues> extends FormikConfig<TValues> {
	title: string;
	isLoading?: boolean;
	isDisabled?: boolean;
...
const FormikModal = <TValues extends FormikValues = FormikValues>(
	...
	const {title, modalRef, children, ModalProps, isLoading, isDisabled, ...FormikProps} = props;

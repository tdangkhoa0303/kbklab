...
export interface DataManagementGridProps<TData, TFormValues extends FormikValues> extends AgGridReactProps, ImportDataButtonProps<TFormValues> {
	title?: string,
	rowData: TData[],
...
export type DataManagementGridPropsWithChildren<TData, TFormValues extends FormikValues> = PropsWithChildren<DataManagementGridProps<TData, TFormValues>>
...
): React.ReactElement<DataManagementGridPropsWithChildren<TData, TFormValues>> => {
	const {
		title,
		rowData,
		children,
...
export default React.memo(DataManagementGrid) as unknown as typeof DataManagementGrid;

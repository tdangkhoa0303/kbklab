...
-- PHP Version: 7.3.0
CREATE DATABASE  IF NOT EXISTS `test_mysql`; --!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' 
USE `test_mysql`;
...
(1, 'root', 'superhardpassword', 'admin');

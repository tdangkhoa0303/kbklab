...
const ConfirmationModalContext = createContext<ConfirmationModalContextValues>(
  confirmationModalContextDefaultValues
);

export const ConfirmationModalContextProvider =
  ConfirmationModalContext.Provider;

export const useConfirmationModal = (): ConfirmationModalContextValues =>
